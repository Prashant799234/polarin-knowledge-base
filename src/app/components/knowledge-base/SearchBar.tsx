...
const ALL_PAGES: SearchResult[] = [
  ...
  { id: "activity-log-overview", label: "Activity Log Overview",        group: "Manage Services",            description: "Why the Activity Log exists and how it helps you track everything" },
  { id: "activity-log-details",  label: "Using Activity Log",           group: "Manage Services",            description: "Audit trail of all platform events with severity levels" },

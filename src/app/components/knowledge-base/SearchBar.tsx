...
const ALL_PAGES: SearchResult[] = [
  ...
  { id: "vista-overview",  label: "VISTA",                              group: "VISTA",                      description: "Real-time traffic analytics, effective rate limits, dynamic add-ons, and telemetry KPIs" },
  { id: "vista-port",      label: "VISTA for Port",                     group: "VISTA",                      description: "Physical port telemetry, optical power (Tx/Rx dBm), traffic & packet analytics (VISTA Premium free)" },
  ...
  { id: "billing-profile",  label: "Billing Profile",                   group: "Organisation · Billing",    description: "Manage billing entities, tax/GST details, and billing contacts" },
  { id: "billing-invoices", label: "Invoices",                          group: "Organisation · Billing",    description: "Download and track billing invoices and payment status" },
  ...
  { id: "reports",         label: "Reports",                            group: "Organisation",               description: "On-demand telemetry downloads and automated scheduled SLA reports for DCI, Ports, and Virtual Connections" },

...
const ALL_PAGES: SearchResult[] = [
  ...
  { id: "port-status",     label: "Understand Port Status",             group: "Products · Port",            description: "Design, Ordered, Live, Failed — what each status means" },
  { id: "port-lag",        label: "Create a Link Aggregation Group",    group: "Products · Port",            description: "Bundle ports for higher throughput with LACP" },
  { id: "vr-overview",     label: "What Is a Virtual Router?",          group: "Products · Virtual Router",  description: "Software L3 routing for multi-cloud and hub-and-spoke topologies" },
  { id: "vr-create",       label: "Create a Virtual Router",            group: "Products · Virtual Router",  description: "L3 gateway for routing between clouds and data centres" },
  { id: "vr-status",       label: "Understand Virtual Router Status",   group: "Products · Virtual Router",  description: "Provisioning states from Design to Live" },
  { id: "vc-overview",     label: "What Is a Virtual Connection?",      group: "Products · Virtual Connection", description: "DC to DC, DC to Cloud, and Cloud to Cloud point-to-point links" },
  { id: "cloud-connect",   label: "Create a Virtual Connection",        group: "Products · Virtual Connection", description: "Private, direct point-to-point links between two endpoints" },
  { id: "dci-overview",    label: "What Is Data Centre Interconnect?",  group: "Products · DCI",              description: "High-bandwidth DCI Wave and Layer 2 links for replication and DR" },
  { id: "dci-create",      label: "Create a Data Centre Interconnect",  group: "Products · DCI",              description: "Link two or more of your data centre sites together" },
  { id: "ix-overview",     label: "What Is Internet Exchange?",         group: "Products · Internet Exchange", description: "Peer directly with other networks instead of paying for transit" },
  { id: "ix-create",       label: "Set Up Internet Exchange",           group: "Products · Internet Exchange", description: "Peer directly with other networks at a Polarin location" },
  { id: "service-detail",  label: "Understanding the Service Detail Page", group: "Service Management",      description: "The shared page layout every service opens into" },
  { id: "service-status",  label: "Understanding Service Status",       group: "Service Management",         description: "Design, Ordered, Live — the lifecycle every product shares" },
  { id: "vista-overview",  label: "VISTA",                              group: "VISTA",                      description: "Performance monitoring and threshold alerts" },
  { id: "complete-profile", label: "Complete Organisation Profile",      group: "Settings",                   description: "Set up org details and authorised signatory" },
  { id: "org-kyc",         label: "KYC Document Requirements",          group: "Settings",                   description: "Proof of identity documents for Indian and global entities" },
  { id: "org-settings",    label: "Organisation Settings",              group: "Settings",                   description: "Manage organisation-wide settings and preferences" },
  { id: "invite-members",  label: "User Management",                    group: "Settings",                   description: "Invite colleagues and manage role-based access" },
  { id: "billing-invoices", label: "Invoices",                          group: "Settings · Billing Profile", description: "Download and manage billing invoices" },
  { id: "billing-payment", label: "Payment Methods",                    group: "Settings · Billing Profile", description: "Manage credit cards and payment options" },
  { id: "activity-log-overview", label: "Activity Log Overview",        group: "Settings",                   description: "Why the Activity Log exists and how it helps you track everything" },
  { id: "activity-log-details",  label: "Using Activity Log",           group: "Settings",                   description: "Audit trail of all platform events with severity levels" },

...
const ALL_PAGES: SearchResult[] = [
  ...
  { id: "cloud-connect",   label: "Cloud Connect",                      group: "Products",                   description: "Private, direct links into major cloud providers" },
  { id: "dci-create",      label: "Data Centre Interconnect",           group: "Products",                   description: "Link two or more of your data centre sites together" },
  { id: "internet-exchange", label: "Internet Exchange",                group: "Products",                   description: "Peer directly with other networks at a Polarin location" },
